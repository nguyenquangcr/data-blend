...
const ROOTS = {
  ...
  app: '/app',
  docs: '/docs',
  dataIntegration: '/app/di'
};

export const PATH_DATA_INTEGRATION = {
  root: ROOTS.dataIntegration,
  list: path(ROOTS.dataIntegration, '/'),
  detail: path(ROOTS.dataIntegration, '/:idProject'),
  orchestrate: path(ROOTS.dataIntegration, '/:idProject/orchestrate'),
  uploadfile: path(ROOTS.dataIntegration, '/:idProject/uploadfile'),
  monitor: path(ROOTS.dataIntegration, '/:idProject/pipelinerun'),
  log: path(ROOTS.dataIntegration, '/:idProject/log/:idPipeline')
};

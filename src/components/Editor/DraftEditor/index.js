  ...
  return {
    root: {
      ...
      '& .dropdown': {
        ...
        '& .rdw-dropdown-selectedtext': { color: theme.palette.text.primary },
        '& .rdw-dropdown-carettoopen': {
          borderTop: `solid 6px ${theme.palette.text.primary}`
        },
        '& .rdw-dropdown-carettoclose': {
          borderBottom: `solid 6px ${theme.palette.text.primary}`
        }
      },
      '& .dropdown__option': {
        width: '100%',
...
function DraftEditor({ className, ...other }) {
